...
# Dataset paths (use your uploaded/processed files)
datasets = {
    "Original": "data.csv",
...
for name, path in datasets.items():
    for p in params:
        try:
            ...
            print(f"Running {name} dataset with n_estimators={p['n_estimators']}, "
                  f"learning_rate={p['learning_rate']}, max_depth={p['max_depth']}")
